...
| Deferred | **M7 Map/Explore/show-me** → [PRD #3](https://github.com/vfarcic/dot-ai-grafana/issues/6) / [PR #22](https://github.com/LesleyMurfin/dot-ai-grafana/pull/22) (0.2.x, not this PR). **GitOps execute** → [PRD #2](https://github.com/vfarcic/dot-ai-grafana/issues/5) / [PR #18](https://github.com/LesleyMurfin/dot-ai-grafana/pull/18). Also: async 202; generated OpenAPI client; Grafana.com signing |
...
- [ ] **M7 — Dashboard deep-link.** **Not in v1.** Owned by [PRD #3](https://github.com/vfarcic/dot-ai-grafana/issues/6) / [PR #22](https://github.com/LesleyMurfin/dot-ai-grafana/pull/22) (plugin 0.2.x). Do not land on vfarcic#3.
...
```
  ...
  PRD #2  vfarcic#5 / fork #18                  post-v1    GitOps PR execute
  PRD #3  vfarcic#6 / fork #22                  0.2.x      Map / Explore / show-me
```
...
| **#2** | [vfarcic#5](https://github.com/vfarcic/dot-ai-grafana/issues/5) · [PR #18](https://github.com/LesleyMurfin/dot-ai-grafana/pull/18) | GitOps PR execute | M7 Map, v1 packing |
| **#3** | [vfarcic#6](https://github.com/vfarcic/dot-ai-grafana/issues/6) · [PR #22](https://github.com/LesleyMurfin/dot-ai-grafana/pull/22) | Map `/d/<uid>`, Explore/Drilldown, show-me skip POST, markdown Answer | GitOps execute, v1 0.1.0 |
...
| *(new in this revision)* | **M7** dashboard→intent deep-link — **Not in v1**; [PRD #3](https://github.com/vfarcic/dot-ai-grafana/issues/6) |
...
| 2026-09-08 | **Supersedes the fork PRD #2 / PRD #3 trackers named in the Deferred, M7, and Related-PRDs rows:** GitOps execute is tracked upstream as [vfarcic/dot-ai-grafana#5](https://github.com/vfarcic/dot-ai-grafana/issues/5) (was fork [issue #13](https://github.com/LesleyMurfin/dot-ai-grafana/issues/13)); Map / Explore / show-me is tracked upstream as [vfarcic/dot-ai-grafana#6](https://github.com/vfarcic/dot-ai-grafana/issues/6) (was fork [issue #23](https://github.com/LesleyMurfin/dot-ai-grafana/issues/23)) | Verified with `gh` on 2026-09-08: fork issues #13 and #23 are **CLOSED** and upstream #5 and #6 are **OPEN** with the same scope; fork PRs #18 and #22 are closed unmerged. The dated 2026-09-01 / 2026-09-02 rows and Work Log entries that name the fork trackers stay verbatim as history; `prds/STATUS.md` already records the 2026-09-03 closure. Fork links still resolve and `origin` is still the fork, so the fork URLs are kept, not rewritten |
...
### 2026-09-08 — fork PRD trackers superseded upstream

- **Issue**: The Deferred, M7, and Related-PRDs rows point at fork trackers [issue #13](https://github.com/LesleyMurfin/dot-ai-grafana/issues/13) and [issue #23](https://github.com/LesleyMurfin/dot-ai-grafana/issues/23). `gh` shows both **CLOSED**, with the same scope now open upstream as [vfarcic/dot-ai-grafana#5](https://github.com/vfarcic/dot-ai-grafana/issues/5) and [vfarcic/dot-ai-grafana#6](https://github.com/vfarcic/dot-ai-grafana/issues/6).
- **Action**: Appended a 2026-09-08 Decisions row recording the supersession and citing both the fork and upstream URLs. No dated row or Work Log entry was rewritten, and the fork issue/PR URLs are left in place because they still resolve and `origin` remains the fork. Separately corrected three provably stale live claims in `prds/STATUS.md` (fork PR #26 is **MERGED** 2026-09-03, not "not merged yet"; fork issue #24 is **CLOSED**, so its checkboxes are not "live") and rendered the two `prds/2` / `prds/3` relative links as plain text, since neither file is on this branch, `origin/main`, or `upstream/main`.
