...
> **Numbering:** Assigned **PRD #5**. Filename `prds/5-plugin-usability-verticals.md`. Previously held unnumbered pending its tracking issue; number is **5** even if the GitHub issue number differs. Do **not** reuse 1–4: `1` v1 analysis, `2` GitOps-PR execute, `3` M7 Map, `4` evidence-grounded change safety.
