    ...
    <form onSubmit={onSubmit}>
      <FieldSet label="dot-ai API Settings">
        ...
        <Field
          ...
          description="When on, Query reads Loki/Prometheus/Tempo/Alertmanager and packs those facts into the Ask. When off, no datasource is read — the question, the session Current summary, Map of resource names, and the condensed Prior block (up to 240 chars of earlier questions and answers) are still sent. On by default."
          className={s.marginTop}
        >
          <span>
            <Switch
