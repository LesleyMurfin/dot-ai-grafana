...
- **Query** — Ask questions about your cluster in plain English. The response (`data.result.summary`) is rendered as sanitized markdown — headings, lists, tables, code blocks (unhighlighted), links.
