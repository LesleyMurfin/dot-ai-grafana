...
- **Live host verified 2026-09-01** in this worktree: `curl -sS http://10.43.25.61/api/health` → `{"database":"ok","version":"11.4.0","commit":"b58701869e1a11b696010a6f28bd96b68a2cf0d0"}`; `/public/plugins/devopstoolkit-dotai-app/module.js` returns **200**. Must-pass reference host confirmed at **11.4.0**, matching the pins.
